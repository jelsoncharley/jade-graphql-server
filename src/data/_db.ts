let companies = [
    { id: 1, name: 'Calsoft Inc', image: "/images/logo.webp", duration_id: 1, location_id: 1 },
    { id: 2, name: 'AXIS Capital', image: "/images/axis-capital-logo.png", duration_id: 2, location_id: 3 },
    { id: 3, name: 'Canada Revenue Agency', image: "/images/canadian-revenue-agency.jpg", duration_id: 3, location_id: 2 },
]
...
let positions = [
    { id: 1, title: 'Intern' },
    { id: 2, title: 'Development Engineer' },
    { id: 3, title: 'Data Engineer' },
    { id: 4, title: 'IT Developer' },
    { id: 5, title: 'IT Analyst/Developer' },
]
